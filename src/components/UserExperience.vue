<template>
  <section class="section">
    <div class="container">
      <h2 class="title is-2">User Experience</h2>
      <hr />
...
import VisitedPagesComment from "~/components/VisitedPagesComment";
...
import WishFulfillment from "~/components/WishFulfillment";
